...
import { mockHistory, contentTypes } from '../../data/mockData.js'
...
export default function Dashboard() {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setLoading(false)
      // Fetch dashboard stats after loading simulation
      fetchDashboard()
        .then((data) => setStats(Object.entries(data).map(([key, value]) => {
